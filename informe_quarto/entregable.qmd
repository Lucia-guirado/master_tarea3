...
-   [4.1. Carga y Exploración de Datos](#datos1)
-   [4.1.2. EDA](#eda1)
-   [4.2. Cuestiones a resolver](#cuestiones)
-   [5. Fase 2 (Periodo 2019-2024)](#fase2)
-   [5.1. Carga y Exploración de Datos](#datos2)
-   [5.1.2. EDA](#eda2)
-   [5.2. Cuestiones a resolver](#cuestiones)
...
Lift & Lead es una startup interesada en abrir centros de entrenamiento especializados en halterofilia, debido al auge del crossfit el cual integra técnicas de halterofilia, sería un buen momento para invertir en centros dedicados exclusivamente a este deporte. Por ello, han contratado nuestros servicios para analizar los resultados de los campeonatos europeos de halterofilia.


Lift & Lead busca validar la siguiente hipótesis:

<div style="text-align:center; color:'#E6ECF2' ; font-size:larger; font-weight:bold; border: 2px '#6B8EAD'; padding: 10px;">
    La popularidad del CrossFit está impulsando el interés por la halterofilia en Europa
</div>
